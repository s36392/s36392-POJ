...
public class GradesStatistics {
    ...
    private static void printGradesAverage(int index, ArrayList<Student> students){
        ...
        double gradesAverage = (sum/index);
        System.out.println("The average is: " + gradesAverage);
    }
    ...
    private static void printGradesMedian(int index, ArrayList<Student> students){
        ...
        if (index % 2 == 0){
            median = (students.get(index/2).getGrade() + students.get(index/2+1).getGrade())/2;
        } else {
